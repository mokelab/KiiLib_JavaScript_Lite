...
var apis = [
    { name: "Login as AppAdmin", value: n1 + "Kii.loginAsAdmin = (clientId, clientSecret) => {\n" +
    ...
    { name: "Login as AppUser", value: n1 + "Kii.login = (identifier, password) => {\n" +
    ...
    { name: "Fetch entity", value: n1 + "Kii.fetch = (id) => {\n" +
